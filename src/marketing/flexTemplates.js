...
function upsellSubscribe(liffUrl) {
  return msg('รับดวงรายวันส่วนตัวทุกเช้า 399/เดือน', bubble({
    ...
    lines: [
      ...
      `🔮 เป็นสมาชิกครบ ${loyalty.MILESTONE} รอบ รับสิทธิ์ ${loyalty.REWARD_NAME} — ถามอาจารย์ได้ ${loyalty.MAX_Q} คำถาม`,
    ],
...
function renewalSoon(liffUrl, daysLeft, expireText) {
  ...
  return msg(`สมาชิกของคุณใกล้หมดอายุ (${dayWord})`, bubble({
    ...
    lines: [
      ...
      `🔮 ต่อครบ ${loyalty.MILESTONE} รอบ รับสิทธิ์ ${loyalty.REWARD_NAME} — ถามอาจารย์ได้ ${loyalty.MAX_Q} คำถาม`,
    ],
