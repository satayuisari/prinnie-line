...
const ANGLES = [
  ...
  { key: 'จับรางวัลดูดวงฟรี', hint: 'สมาชิกครบ 14 วันมีสิทธิ์ลุ้นดูดวงตัวต่อตัวกับอาจารย์ฟรี จับรอบละ 1 ท่านทุกวันที่ 2 และ 17 ประกาศชื่อในไลน์ — ต้องบอกให้ชัดว่าเฉพาะสมาชิก' },
...
โทนเสียง: เขียนเหมือนอาจารย์พูดกับลูกดวงตรง ๆ ใช้ภาษาไทยที่คนทั่วไปพูดกันจริง
- ประโยคสั้น เข้าใจได้ในรอบเดียว ไม่ใช้คำโฆษณา ไม่ใช้คำหรู ไม่แปลจากภาษาอังกฤษ
- ห้ามคำแบบ "จังหวะสำคัญ" "พลังงานพิเศษ" "น่าจับตา" "ปลดล็อก" "เวอร์ชัน" "คอนเทนต์"
- ถ้าอ่านแล้วต้องเดาว่าหมายถึงอะไร แปลว่ายังไม่ชัด ให้เขียนใหม่
- ลงท้าย "ค่ะ/นะคะ" ตามธรรมชาติ ไม่ต้องทุกบรรทัด
ความยาว: 6–12 บรรทัด ขึ้นบรรทัดใหม่บ่อย ๆ อ่านบนมือถือสบายตา อิโมจิไม่เกิน 2 ตัวทั้งโพสต์

ตัวอย่างน้ำเสียงจริงของอาจารย์ (จากดวงที่ส่งให้สมาชิกทุกวัน ให้เขียนตามสำนวนนี้):
"ดาวแห่งความคิดทำมุมที่ดีกับคุณ คุณค่อนข้างจะสื่อสารได้ดีในช่วงนี้ จากที่ผ่านปัญหาในการสื่อสารกับผู้อื่นที่ผ่านมา ความคิดของคุณแจ่มใส เป็นช่วงจังหวะเวลาที่ดีมากที่จะใช้แก้ปัญหา"
"ถ้าคุณเปิดได้ไพ่ใบนี้เป็นใบแรก คุณเป็นคนที่มีจิตใจอ่อนโยน คุณสามารถเข้าใจถึงอารมณ์และความรู้สึกของผู้อื่นได้"
(พูดกับผู้อ่านว่า "คุณ" ตรง ๆ เล่าเป็นเรื่อง ไม่ขายของ)
...
- จับรางวัลดูดวงฟรีกับอาจารย์ (สำหรับสมาชิกเท่านั้น): ทุกวันที่ 2 และ 17 จับรางวัลให้สมาชิกที่เป็นสมาชิกครบ 14 วัน รอบละ 1 ท่าน ได้ดูดวงตัวต่อตัวฟรี 1 ชั่วโมง ประกาศชื่อผู้ได้รับในไลน์ แล้วนัดเวลาหลังจากนั้น — ต้องบอกให้ชัดว่า "ต้องเป็นสมาชิก" และ "รอบละ 1 ท่าน" ห้ามเขียนให้คนอ่านเข้าใจว่าตัวเองได้รางวัลแล้ว

ห้ามเด็ดขาด:
- ใช้ภาษาไทยธรรมดา ชัดถ้อยชัดคำ ห้ามกำกวม ห้ามใช้คำว่า "ดวงเลือกคุณ" เป็นหัวข้อ
...
function fallbackDraft(angle) {
  const body = {
    ...
    'จับรางวัลดูดวงฟรี': 'สมาชิก Prinnie333 มีสิทธิ์ลุ้นดูดวงตัวต่อตัว\nกับอาจารย์ฟรี 1 ชั่วโมงค่ะ\n\nเราจับรางวัลทุกวันที่ 2 และ 17 รอบละ 1 ท่าน\nเป็นสมาชิกต่อเนื่องครบ 14 วัน มีชื่อลุ้นให้อัตโนมัติ\nประกาศชื่อผู้ได้รับในไลน์ทุกรอบนะคะ\n\nสมาชิก 399 บาท / 30 วัน\nได้ดวงรายวันเฉพาะคุณทุกเช้า 08:00 ด้วยค่ะ',
