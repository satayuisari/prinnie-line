...
const ANGLES = [
  ...
  { key: 'ดวงเลือกคุณ', hint: 'สิทธิ์ดูดวงตัวต่อตัวฟรีของสมาชิก คัดจากดวงกำเนิดทุกวันที่ 2 และ 17' },
...
- "ดวงเลือกคุณ": ทุกวันที่ 2 และ 17 ระบบคัดดวงสมาชิกที่ดาวจรทำมุมแรงที่สุด 1 ดวง ได้ดูดวงตัวต่อตัวฟรี 1 ชั่วโมง เป็นสมาชิกครบ 14 วันเข้าเกณฑ์เอง
...
function fallbackDraft(angle) {
  const body = {
    ...
    'ดวงเลือกคุณ': 'ทุกวันที่ 2 และ 17\nระบบจะคำนวณว่าดาวจรช่วงนั้น\nทำมุมกับดวงกำเนิดของสมาชิกคนไหนแรงที่สุด\n\nดวงนั้นจะได้เปิดดวงกับอาจารย์ตัวต่อตัว\nเต็ม 1 ชั่วโมง ไม่มีค่าใช้จ่ายเพิ่มค่ะ\nเป็นสมาชิกครบ 14 วัน ดวงเข้าสู่การคำนวณเองค่ะ',
